...
![alt text](cpfilefile1.jpg)

### mv file file2
#### Moves (or renames) file to file2.
![alt text](mvfilefile2.jpg)

### rm file2
#### Permanently deletes file2.
![alt text](rmfile2.jpg)
